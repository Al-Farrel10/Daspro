...
public class Tugas2_12 {
    public static void main(String[] args) {
        ...
        // Deklarasi variabel
        double panjangTanah, lebarTanah, diameterKolam, sisiTaman, luasTanah, jariJari,luasKolam, luasTaman, luasSisa;               //panjangTanah, lebarTanah, diameterKolam, sisiTaman, luasTanah, jariJari, luasKolam, luasTaman, luasSisa
